...
public class CoreAccountVO implements BaseVO {
	...
	*/
	...
	public void convertPOToVO(Object poObj) {
		...
		this.cractCdate = po.getCractCdate()!=null?DateUtil.formatTimesTampDate(po.getCractCdate()):"";
		this.cractUdate = po.getCractUdate()!=null?DateUtil.formatTimesTampDate(po.getCractUdate()):"";
