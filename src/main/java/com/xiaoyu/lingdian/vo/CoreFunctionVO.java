...
public class CoreFunctionVO implements BaseVO {
	...
	*/
	...
	public void convertPOToVO(Object poObj) {
		...
		this.crfntCdate = po.getCrfntCdate()!=null?DateUtil.formatTimesTampDate(po.getCrfntCdate()):"";
		this.crfntUdate = po.getCrfntUdate()!=null?DateUtil.formatTimesTampDate(po.getCrfntUdate()):"";
