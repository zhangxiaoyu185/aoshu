...
//				}
	...
	$("body").delegate(".searchBtn","click",function(){
		...
		ModifyData('code_papers',  $(".crqtsCode").val());
		ModifyData('class_papers',  $(".crqtsClass").val());
		pageNum_search = 1;
		ModifyData('num_papers',  pageNum_search);
	});
	//重置
...
function Modify(msgObject){
	...
	crpesContent = JSON.stringify(content);
	var str = 'crpesUuid='+encodeURIComponent(crpesUuid)+'&crpesContent='+encodeURIComponent(crpesContent);
	getOData(str,"corePapers/update/corePapers/by/ques",{
		fn:function(oData){
...
function getDataClass(){
	var str = 'crcdaUuid=class_papers';
	getOData(str,"coreCacheData/views",{fn:function(oData){
		if(oData.code == 1) {
