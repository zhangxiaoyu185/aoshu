...
function Add(msgObject){
	...
	var str = 'crkleName='+encodeURIComponent(crkleName)+'&crkleTop='+encodeURIComponent(crkleTop)+'&crkleCategory='+encodeURIComponent(crkleCategory);
