//var urlfile = "http://192.168.0.9/aoshu/";
//var urlfile = "http://caipiao.hzlingdian.com/aoshu/";
var urlfile = "http://127.0.0.1:8080/aoshu/";

var packageName = "aoshu_";
...
function ajaxTool(type,data,url,error,success) {
	$.ajax({
		data: data,
		type: type,  
	    url: url,
